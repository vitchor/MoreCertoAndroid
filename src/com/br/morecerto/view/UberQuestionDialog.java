...
public class UberQuestionDialog extends UberDialog {
	...
	public UberQuestionDialog(Context context) {
		this(context, null);
	}

	public UberQuestionDialog(Context context, Bitmap image) {
		super(context, R.layout.uber_question_dialog);
		...
		if (kind == Dialog.BUTTON_POSITIVE) {
			...
			mPositiveButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					dialogListener.onClick(UberQuestionDialog.this, Dialog.BUTTON_POSITIVE);
				}
			});
			...
			mNegativeButton.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View view) {
					dialogListener.onClick(UberQuestionDialog.this, Dialog.BUTTON_NEGATIVE);
				}
			});
		}
	}
